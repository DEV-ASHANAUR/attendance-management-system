<?php
   ...
   if(isset($_GET['class_id']) && isset($_GET['batch_id']) && isset($_GET['date'])){
       ...
       $hasPresent = $obj->checkPresent($date,$batch_id,$class_id);
       $shuter = true;
   }
                              ...
                              <td>
                                 <div class="d-flex justify-content-center">
                                    <div class="form-check mx-4">
                                       <input class="form-check-input" type="radio" name="<?php echo $c;?>" value="<?php echo $row->s_id;?>" id="<?php echo $row->s_id;?>" <?php if(in_array($row->s_id,$presentArr)){echo "checked";} ?> />
                                       <label class="form-check-label" for="<?php echo $row->s_id;?>">
                                       Present
                                       </label>
                                    </div>
                                    <div class="form-check mx-4">
                                       <input class="form-check-input" type="radio" name="<?php echo $c;?>" id="<?php echo $row->s_id."a";?>" value="absent" <?php if(!in_array($row->s_id,$presentArr)){echo "checked";} ?> />
